...
ALTER TABLE bot_config ADD COLUMN IF NOT EXISTS target1_percent INT DEFAULT 50;
ALTER TABLE bot_config ADD COLUMN IF NOT EXISTS target2_level FLOAT DEFAULT 1.0;
ALTER TABLE bot_config ADD COLUMN IF NOT EXISTS target2_percent INT DEFAULT 50;
